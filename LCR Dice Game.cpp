...
* appropriate and remove code as a whole to create a better flow for the program. I completly rebuilt the Dice and Game classes from scratch
...
* another course and leveraged arrays more heavily here to produce the desired results. By using these arrays I leveraged seperate int value
...
int main()
{
    ...
    for (int nameCount = 1; nameCount <= game.numPlayers; nameCount++)
    {
        cout << "Player " << nameCount << " please enter your first name:";
    ...
    do {
        ...
        for (int nameCount = 1; nameCount <= game.numPlayers; nameCount++)
        {
            ...
            else if (game.winner == false)
            {
                ...
                roll.runGame(); // Contains the statements to roll dice for the amount of chips each player has, to a maximum of 3.
                game.x++;
                roll.a++;
            }
        }
